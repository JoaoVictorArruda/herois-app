...
abstract class InfoWatcherState with _$InfoWatcherState {
  ...
  const factory InfoWatcherState.loadListSuccess(
      KtList<Info> info, String userId) = LoadListSuccess;

  const factory InfoWatcherState.loadFailure(InfoFailure infoFailure) =
      LoadFailure;
}
