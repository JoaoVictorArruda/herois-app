...
@injectable
class RequestWatcherBloc extends Bloc<RequestWatcherEvent, RequestWatcherState> {
  final IRequestRepository _requestRepository;

  RequestWatcherBloc(this._requestRepository) : super(const RequestWatcherState.initial());

  StreamSubscription<Either<RequestFailure, KtList<Request>>> _requestStreamSubscription;
    ...
    yield* event.map(
      watchAllStarted: (e) async* {
        ...
        _requestStreamSubscription = _requestRepository
            .watchAll()
            .listen((request) => add(RequestWatcherEvent.requestReceived(request)));
      },
