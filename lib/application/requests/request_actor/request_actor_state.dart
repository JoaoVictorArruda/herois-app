...
abstract class RequestActorState with _$RequestActorState {
  ...
  const factory RequestActorState.editFailure(RequestFailure requestFailure) = EditFailure;

  const factory RequestActorState.deleteFailure(RequestFailure requestFailure) = DeleteFailure;
