    ...
    return BlocConsumer<InfoFormBloc, InfoFormState>(
      ...
      builder: (context, state) {
        ...
        if(state.info.dateLastDonate.getOrCrash() == "null") {
          ...
          textEditingController.text = dateTime.day.toString().padLeft(2, '0') + '/' + dateTime.month.toString().padLeft(2, '0') + '/' + dateTime.year.toString();
        } else {
                  ...
                  child: TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if(picked != null) {
                        context
                            .bloc<InfoFormBloc>()
                            .add(InfoFormEvent.dateLastDonateChange(picked.toIso8601String()));
                      }
                    },
              ),
                ),
