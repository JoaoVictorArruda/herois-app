...
//      ),
    ...
    return BlocBuilder<RequestFormBloc, RequestFormState>(
      buildWhen: (p, c) => p.request.bloodType != c.request.bloodType,
                ...
                return GestureDetector(
                  onTap: () {
                    context
                        ...
                        .add(RequestFormEvent.bloodTypeChanged(itemDescription));
                  },
                  child: Container(
                    width: 40,
                    decoration: state.request.bloodType.value.fold(
                      (_) => notClicked,
                      (bloodType) =>
